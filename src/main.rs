...
fn main() {
  ...
  // let f = murray.blockchain.get_address_transactions(GetAddressParams {address: "3Brz916o2Ng2s6iYT9bgCpAxTRqd9b3GGW".to_string()});
  // println!("{:?}\n", f.unwrap());
  ...
  // let l = blockchain::post_transaction(PostTransactionParams { tx_hex });
  // println!("{:?}\n", l.unwrap());
}
